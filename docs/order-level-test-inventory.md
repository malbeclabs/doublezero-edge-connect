...
- `a_single_paths_stream_reaches_the_consumer_exactly`
...
- `tests/dedup.rs` — `interleaved_book_paths_publish_one_coherent_stream`
...
- `src/sinks/ws.rs` (replay/bootstrap) — `connect_replays_the_accumulated_book_rebaseline`, `the_book_replay_scope_always_follows_the_market`, `subscribe_scopes_the_book_replay_by_channel`, `instrument_is_replayed_before_the_book`, `mid_stream_markets_are_not_replayed`, `a_lagging_client_is_rebaselined`, `prepare_populates_the_channel_for_book_and_instrument`
