#!/usr/bin/env bash
#
# DoubleZero Edge Connect installer
# ---------------------------------
# Served from https://get.doublezero.xyz/connect and run as:
#
...
# (ghcr.io/malbeclabs/doublezero-edge-connect:mainnet-beta), runs
...
# config / defaults
# ----------------------------------------------------------------------------
DZ_IMAGE="${DZ_IMAGE:-ghcr.io/malbeclabs/doublezero-edge-connect:mainnet-beta}"
